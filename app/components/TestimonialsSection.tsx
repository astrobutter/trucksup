    ...
    <section className={styles.section}>
      <div className="container">
        ...
        <div className={styles.carousel}>
          <button className={styles.arrow} aria-label="Previous testimonial" onClick={() => rotate(-1)}>
          ...
          <button className={styles.arrow} aria-label="Next testimonial" onClick={() => rotate(1)}>
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
              <path d="M9 6l6 6-6 6" />
            </svg>
          </button>
